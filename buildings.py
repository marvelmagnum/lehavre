...
steel_mill.build_cost = {'brick': 4, 'iron': 2}
steel_mill.fees = [{'money': 2}]
steel_mill.rank = 23
steel_mill.value = steel_mill.price = 22
steel_mill.type = "industrial"
steel_mill.icon = []
...
steel_give_iron = actionblocks.RemoveItems('iron', 1)
steel_spend_energy = actionblocks.SpendEnergy(5)
steel_get_steel = actionblocks.AddItems('steel',1)
steel_mill.actions = [steel_give_iron, steel_spend_energy, steel_get_steel]

storehouse = Building()
storehouse.name = "storehouse"
storehouse.build_cost = {'wood': 2, 'brick': 2}
storehouse.fees = [{'money': 2}]
storehouse.rank = 24
storehouse.value = 4
storehouse.price = 10
storehouse.type = "economic"
